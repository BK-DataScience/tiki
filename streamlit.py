...
########### Phần tạo giao diện #############################################
#GUI
st.title('Master thesis in Telecommunication engineering - Recommendation System')
...
if choice == 'Mục Tiêu Kinh Doanh':
    ...
    st.markdown("""
    - Tiki là 1 hệ sinh thái thương mại 'all in one', trong đó có tiki.vn, là một website thương mại điện tử đứng top 3 của Việt Nam, top 7 khu vực Đông Nam Á. Trên trang này đã triển khai nhiều tiện ích hỗ trợ nâng cao trải nghiệm người dùng và họ muốn xây dựng nhiều tiện ích hơn nữa.
    - Hệ thống khuyến nghị sản phẩm là tiện ích không thể thiếu đối với các trang thương mại điện tử hiện nay. Gợi ý sản phẩm giúp mang lại những sản phẩm phù hợp cho khách hàng, cũng như mang lại những trải nghiệm tốt nhất cho khách hàng, qua đó đáp ứng nhu cầu mua sắm.
    ...
    st.markdown("""
    Thực hiện nghiên cứu, khám phá dữ liệu công ty đang có và xây dựng mô hình theo 2 phương pháp:
    ...
    st.markdown("""
    Trong quá trình tìm hiểu khám phá dữ liệu, tôi đã rút ra được những thông tin hữu ích về sản phẩm, thương hiệu, khách hàng, giá cả và đánh giá chất lượng trên tiki.vn.
    """)
    ...
    """)
    st.markdown("""
    Đối với phương pháp này, cụ thể là Gensim và Cosine Similarity, tôi xây dựng mô hình Recommendation System theo quy trình sau:
    ...
    st.markdown("""
    Đối với phương pháp này, tôi xây dựng mô hình đề xuất/gợi ý theo quy trình sau:
